...
const DICT = {
  zh: {
    nav_studio: '创作台', nav_templates: '模板网络', nav_creator: '创作者', nav_metrics: '数据', nav_pricing: '定价',
    login: '登录', logout: '退出', cta_signup: '免费注册',
    ...
    hero_note: '免费额度含 20 点 · 无需绑定信用卡 · 支持 9 种语言',
    why_title: '为什么选择万卡', why_sub: '不只是生成内容，而是一张越用越强的营销内容网络。',
    how_sub: '不用会设计、不用会写文案。填一次，成套产出，直接投放。',
    testi_sub: '来自跨境卖家、独立站运营和内容创作者的真实反馈。',
    pricing_sub: '免费开始，按需升级。随时取消，无隐藏费用。',
    most_popular: '最受欢迎',
    footer_tagline: '为跨境卖家与中小商家打造的 AI 营销内容创作网络。',
    footer_product: '产品', footer_company: '公司', footer_legal: '法务',
    footer_about: '关于我们', footer_blog: '博客', footer_contact: '联系我们',
    footer_privacy: '隐私政策', footer_terms: '服务条款',
    footer_rights: '保留所有权利。', footer_made: '为全球卖家而造 🌍',
    studio_empty: '填写左侧信息，一键生成整套多语言营销内容 →', templates_empty: '暂无模板，快去创作台生成并发布第一个吧！',
    creator_empty: '你还没有发布模板。发布后，别人每次使用你都能获得分成。', loading: '加载中…', auth_join: '30 秒创建账号，免费开始',
  },
  en: {
    nav_studio: 'Studio', nav_templates: 'Templates', nav_creator: 'Creator', nav_metrics: 'Metrics', nav_pricing: 'Pricing',
    login: 'Log in', logout: 'Log out', cta_signup: 'Start free',
    ...
    hero_note: 'Free plan includes 20 credits · No credit card · 9 languages',
    why_title: 'Why Wanka', why_sub: 'Not just content generation — a marketing content network that gets stronger the more you use it.',
    how_sub: 'No design skills. No copywriting. Fill it once, get a full set, publish straight to your channels.',
    testi_sub: 'Real feedback from cross-border sellers, DTC operators and content creators.',
    pricing_sub: 'Start free, upgrade when you need to. Cancel anytime, no hidden fees.',
    most_popular: 'Most popular',
    footer_tagline: 'The AI marketing-content creation network built for cross-border sellers and small merchants.',
    ...
    footer_rights: 'All rights reserved.', footer_made: 'Built for sellers worldwide 🌍',
    studio_empty: 'Fill in the details on the left and generate a full multilingual content set →', templates_empty: 'No templates yet — head to the Studio to create and publish the first one!',
    creator_empty: 'You haven\'t published any templates yet. Once you do, you earn a share every time someone uses them.', loading: 'Loading…', auth_join: 'Create an account in 30s, start free',
  },
};
